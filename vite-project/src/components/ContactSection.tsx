...
const ContactSection = () => {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const message = encodeURIComponent(
      `Olá! Gostaria de saber mais sobre a ILPI Aconchego dos Avós.%0A` +
  ...
  const directWhatsapp = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
    'Olá! Quero falar com a ILPI Aconchego dos Avós.',
  )}`
